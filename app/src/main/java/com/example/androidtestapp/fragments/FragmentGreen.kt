...
class FragmentGreen : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.button_gr_go_to_red.setOnClickListener { router.showFragment(RedFragment) }
        view.button_gr_go_to_blue.setOnClickListener { router.showFragment(BlueFragment) }
    }
}