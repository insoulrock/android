...
class FragmentBlue : ColorFragment() {
    ...
    override fun onCreateView(
        ...
        view.button_bl_go_to_green.setOnClickListener { openFragment(router.getGreenFragment())}
        view.button_bl_go_to_red.setOnClickListener { openFragment(router.getRedFragment())}
